            ...
            try {
                ...
                if (data.code == 00000) {
                   luckDrawCount = data.data.luckDrawCount
                    log('抽奖次数：'+data.data.luckDrawCount)
                } else 
                    log(data.message)
        ...
        axios.request(options).then(async function(response) {
            try {
                ...
                if (data.code == 00000) {
                    ...
                    log('抽奖获得：'+data.data.prizeCount+data.data.prizeName)
                } else 
                    log(data.message)
